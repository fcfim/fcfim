...
- **🏗️ Pascalc & AvaliadorPro:** SaaS ecosystem removing human error from structural calculations and real estate valuations.
- **🧱 Engineering APIs:** Exposing complex structural algorithms as documented REST APIs to break industry silos.
- **📚 ConcursosPro:** High-performance EdTech focused on execution data.
- **⚙️ Legacy Automation:** Custom scripts integrating disconnected systems for public and private sectors.
